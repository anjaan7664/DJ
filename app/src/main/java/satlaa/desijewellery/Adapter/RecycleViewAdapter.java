...
public class RecycleViewAdapter extends RecyclerView.Adapter {
    ...
    public RecycleViewAdapter(Context context, ArrayList<Object> images, ClickListener listener) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case 1:
                View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_admob, parent, false);
